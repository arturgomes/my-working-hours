import { WorkSchedule, AvailabilityStatus } from '../types';
...
export const isTimeWithinSchedule = (
  ...
  const currentTimeString = currentTime.toLocaleTimeString('en-US', timeOptions);
...
export const calculateAvailability = (
  ...
  if (isAvailable) {
    ...
    const nextAvailableDate = getNextAvailableTime(now, userSchedule, userTimezone);
